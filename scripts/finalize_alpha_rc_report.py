"""Create the Phase 11.4 result after GitHub has signed and verified the RC."""
...
try:
    from scripts.build_alpha_rc_bundle import RC_NAME, sha256_file
except ModuleNotFoundError:
    from build_alpha_rc_bundle import RC_NAME, sha256_file
...
def finalize_report(
    *,
    ...
    report: dict[str, Any] = {
        "schema_version": 1,
        "evaluation": "evidencemesh-phase11-4-alpha-rc-v1",
        "phase": "11.4",
        "scored": False,
        "environment": {

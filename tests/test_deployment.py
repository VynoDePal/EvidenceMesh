...
def test_phase11_8_workflow_requires_manual_live_authorization_and_locks_budget() -> None:
    ...
    assert "if [[ -e benchmarks/results/phase11_8_recovery_2026-07-29.json ]]; then" in live
    assert "if [[ -e benchmarks/results/phase11_8_recovery_2026-07-29.md ]]; then" in live
